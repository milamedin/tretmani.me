-- Patch 003: bogati cijenovnici za 3 test salona (grupe, opisi, cijene).
-- Pokreni u Supabase SQL Editoru. Posle pokreni `npm run build` (ili push) za novi sajt.

update salons set services = '[
